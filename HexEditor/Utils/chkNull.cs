...
namespace HexEditor
{
    ...
    static class chkNull
    {
        ...
        /// <returns></returns>
        internal static bool isNull<T>(T obj)
        {
        ...
        /// ie you may not want to pass nulls to SQL string variables
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="obj"></param>
        /// <returns></returns> 
        internal static string whenNull<T>(T obj)
        {
            if (obj == null)
            {
                return "";
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        internal static double numNull<T>(T obj)
        {
            try
            {
                if (obj == null)
            ...
            catch
            {
                ...
                // I'm using it to verify they passed in a number
                return 0;
            }
        }
